      ...
      //console.log(msg);
                 ...
                 /*
                    ...
                    console.log(y);*/
                      ...
                      series[i].addPoint([msg.timestamp,y], true, false);
/*
...
tinydb[i][j][3]=0;
                 			...
                 			if (name[0] == 2 && n != 0) series[i].addPoint([lastredraw-offset,val/n], true, false);
                 			else if (name[0] == 3 && n != 0) series[i].addPoint([lastredraw-offset,val], true, false);
                 		}}
                 	});
                 	/*
